...
export const sections: Section[] = [
  ...
  },
  {
    ...
    color: 'pink',
    topics: [
      { title: 'Bubble Sort', slug: 'bubble-sort', readTime: '6 min', hasVisualizer: true, comingSoon: false },
      { title: 'Selection Sort', slug: 'selection-sort', readTime: '6 min', hasVisualizer: true, comingSoon: false },
      { title: 'Insertion Sort', slug: 'insertion-sort', readTime: '6 min', hasVisualizer: false, comingSoon: true },
      { title: 'Merge Sort', slug: 'merge-sort', readTime: '8 min', hasVisualizer: true, comingSoon: false },
      { title: 'Quick Sort', slug: 'quick-sort', readTime: '9 min', hasVisualizer: true, comingSoon: false },
  ...
  },
  {
    ...
    topics: [
      ...
      { title: 'BFS', slug: 'bfs', readTime: '10 min', hasVisualizer: true, comingSoon: false },
      { title: 'DFS', slug: 'dfs', readTime: '10 min', hasVisualizer: true, comingSoon: false },
      { title: "Dijkstra's", slug: 'dijkstras', readTime: '12 min', hasVisualizer: true, comingSoon: false },
  ...
  },
  {
    ...
    color: 'pink',
    topics: [
      { title: "Kruskal's", slug: 'kruskals', readTime: '10 min', hasVisualizer: true, comingSoon: false },
      { title: "Prim's", slug: 'prims', readTime: '10 min', hasVisualizer: true, comingSoon: false },
      { title: "Tarjan's", slug: 'tarjans', readTime: '14 min', hasVisualizer: true, comingSoon: false },
      { title: "Kosaraju's", slug: 'kosarajus', readTime: '12 min', hasVisualizer: true, comingSoon: false },
      { title: 'KMP', slug: 'kmp', readTime: '12 min', hasVisualizer: true, comingSoon: false },
      { title: 'Rabin-Karp', slug: 'rabin-karp', readTime: '10 min', hasVisualizer: true, comingSoon: false },
